...
<!-- ======================================================== -->
<!-- MODAL: RIWAYAT PEMBAYARAN PER ORDER -->
<!-- ======================================================== -->
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header">
                <h6 class="modal-title fw-bold">
                    <i class="bi bi-clock-history text-primary me-2"></i>Riwayat Pembayaran
                    <span id="detailPoLabel" class="text-muted fw-normal small d-block mt-1"></span>
                </h6>
            ...
            <div class="modal-footer justify-content-between">
                <div class="fw-bold text-dark">Total: <span id="detailPembayaranTotal" class="text-success">Rp 0</span></div>
...
function bukaDetailPembayaran(orderId, nomorPo, namaPerusahaan) {
    ...
    document.getElementById('detailPoLabel').textContent = label + ' — ' + namaPerusahaan;

    var body = document.getElementById('detailPembayaranBody');
    body.innerHTML = '';

    var riwayat = semuaPembayaran.filter(function (p) {
        return parseInt(p.order_id, 10) === parseInt(orderId, 10);
    });

    var total = 0;
    if (riwayat.length === 0) {
        body.innerHTML = '<tr><td colspan="4" class="text-center text-muted py-4">Belum ada transaksi untuk order ini.</td></tr>';
    } else {
        riwayat.forEach(function (p) {
            ...
            tr.innerHTML =
                '<td>' + tglLabel + '</td>' +
                '<td class="text-center"><span class="badge badge-pill-primary">Termin ke-' + p.termin_ke + '</span></td>' +
