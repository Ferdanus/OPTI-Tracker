...
<head>
    ...
    <style>
        :root {
            ...
            --color-primary-darker: #2c0210;   /* Maroon lebih gelap (gradasi sidebar) */
        ...
        .sidebar-brand-text { line-height: 1.15; overflow: hidden; white-space: nowrap; }
        .sidebar-brand-title { font-size: 1rem; font-weight: 800; color: #ffffff; margin: 0; }
        .sidebar-brand-subtitle { font-size: 0.65rem; font-weight: 600; color: rgba(255, 255, 255, 0.5); letter-spacing: 0.3px; margin: 0; }
        ...
        .sidebar-user:hover { background-color: rgba(255, 255, 255, 0.08); }
        ...
        .sidebar-user-text { overflow: hidden; white-space: nowrap; line-height: 1.2; }
        .sidebar-user-name { color: #ffffff; font-weight: 700; font-size: 0.8rem; }
        ...
        .user-menu-btn .user-avatar { background: var(--color-primary); }
        ...
        .content-wrapper.collapsed { margin-left: var(--sidebar-width-collapsed); }
        ...
        @media (max-width: 991.98px) {
            ...
            .sidebar.collapsed .sidebar-section-label,
            .sidebar.collapsed .sidebar-link span,
            .sidebar.collapsed .sidebar-user-text { display: block; }
            .sidebar.collapsed .sidebar-link,
            .sidebar.collapsed .sidebar-user { justify-content: flex-start; }

            .content-wrapper, .content-wrapper.collapsed { margin-left: 0; }
        ...
        .footer-gov a { color: #cbd5e1; text-decoration: none; transition: color 0.15s ease; }
        .footer-gov a:hover { color: #ffffff; }
    </style>
</head>
<body>
        ...
        <aside class="sidebar" id="sidebar">
            <a class="sidebar-brand" href="<?= ($BASE) ?>/po">
                ...
                <div class="sidebar-brand-text">
                    ...
                    <p class="sidebar-brand-subtitle">BBSPJI SELULOSA &bull; KEMENPERIN RI</p>
                </div>
            </a>
            ...
            <?php endif; ?>
                <?php if ($SESSION['role'] == 'admin_order'): ?>
                    <li class="sidebar-section-label">Menu Utama</li>
                <li>
                    <a class="sidebar-link <?= ($active_menu == 'admin-order' ? 'active' : '') ?>" href="<?= ($BASE) ?>/admin-order">
                ...
                <li>
                    <a class="sidebar-link <?= ($active_menu == 'pengujian-eksternal' ? 'active' : '') ?>" href="<?= ($BASE) ?>/pengujian-eksternal">
...
" ?>
        ...
        <div class="content-wrapper" id="contentWrapper">
            ...
            <nav class="topbar">
                ...
                <button class="sidebar-toggle-btn desktop-collapse-btn" type="button" id="desktopCollapseBtn" aria-label="Ciutkan menu">
            ...
            <footer class="footer-gov">
                <div class="container-fluid px-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 text-center text-md-start">
                    <div>
                    ...
                    <div class="text-white-50">&copy; 2026 Sistem OPTI Tracker. Hak Cipta Dilindungi.</div>
                </div>
            </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var desktopBtn = document.getElementById('desktopCollapseBtn');
            ...
            // Desktop: collapse to icon-only rail, remembered across page loads
            function applyCollapsed(isCollapsed) {
                sidebar.classList.toggle('collapsed', isCollapsed);
                contentWrapper.classList.toggle('collapsed', isCollapsed);
            }
            var savedState = localStorage.getItem('opti_sidebar_collapsed') === '1';
            ...
            if (desktopBtn) {
                desktopBtn.addEventListener('click', function () {
                    ...
                    localStorage.setItem('opti_sidebar_collapsed', nowCollapsed ? '1' : '0');
                });
            }
