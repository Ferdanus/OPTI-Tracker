                    ...
                    <div class="dropdown ms-lg-3">
                        <a class="nav-user-link d-flex align-items-center gap-2 text-decoration-none dropdown-toggle" href="#" role="button" id="userMenuDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php if ($SESSION['foto_profil'] && file_exists($SESSION['foto_profil'])): ?>
                                    ...
                                    <img src="<?= ($BASE) ?>/<?= ($SESSION['foto_profil']) ?>" class="rounded-circle flex-shrink-0" style="width: 32px; height: 32px; object-fit: cover; border: 1px solid rgba(164, 30, 34, 0.15);" alt="Foto Profil">
                                
                                <?php else: ?>
                                    <div class="nav-avatar bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center fw-bold flex-shrink-0" style="width: 32px; height: 32px; font-size: 0.85rem; border: 1px solid rgba(164, 30, 34, 0.15);">
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        ...
                        <?php if (preg_match('/^\/kontrak/', $PATH)): ?>
                            <?php if ($PATH == '/kontrak'): ?>
                                
                                    <li class="breadcrumb-item active text-dark fw-semibold" aria-current="page">Daftar Kontrak PKS</li>
                                
                                <?php else: ?>
                                    <li class="breadcrumb-item"><a href="<?= ($BASE) ?>/kontrak" class="text-decoration-none">Daftar Kontrak PKS</a></li>
                                    <li class="breadcrumb-item active text-dark fw-semibold" aria-current="page">Tambah Kontrak PKS</li>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li class="mb-2"><a href="<?= ($BASE) ?>/kontrak">Manajemen Kontrak PKS</a></li>
