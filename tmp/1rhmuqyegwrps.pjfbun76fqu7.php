    ...
    <div class="app-shell">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class="sidebar-link <?= ($active_menu == 'surat-penawaran' ? 'active' : '') ?>" href="<?= ($BASE) ?>/surat-penawaran" title="Kontrak PKS">
                        <i class="bi bi-journal-text"></i> <span>Permintaan Pelayanan Jasa</span> 
                    </a>
                </li>
                <li>
                    <a class="sidebar-link <?= ($active_menu == 'proposal' ? 'active' : '') ?>" href="<?= ($BASE) ?>/proposal" title="Kontrak PKS">
                        <i class="bi bi-journal-text"></i> <span>Proposal</span> 
                    </a>
                </li>
            <?php endif; ?>
