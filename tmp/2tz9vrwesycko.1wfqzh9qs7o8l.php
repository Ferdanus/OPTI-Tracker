                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-3">
                        ...
                        <select name="status_rancop" id="statusRancopSelect" class="form-select form-select-sm mb-3 fw-semibold" onchange="updateStatusBadge(this.value)">
                            ...
                            <option value="diskusi" <?= ($order['status_rancop'] == 'diskusi' ? 'selected' : '') ?>>🔵 Diskusi / Dilan-dilan (Nego Klien)</option>
                        ...
                        <div id="statusInfoBox" class="p-3 rounded-2 small mb-3 bg-light border">
                            <i class="bi bi-info-circle text-primary me-1"></i>
                            <span id="statusInfoText">Pilih status untuk merefleksikan progres negosiasi teknis dengan klien.</span>
                        </div>
...
function updateStatusBadge(val) {
    ...
    if (val === 'draft') {
        infoText.textContent = 'Tahap awal penyusunan rancangan percobaan oleh tim teknis.';
    } else if (val === 'diskusi') {
        infoText.textContent = 'Sedang dalam sesi diskusi / negosiasi teknis (Zoom/telepon) bersama klien.';
    } else if (val === 'deal') {
        infoText.textContent = 'Kesepakatan tercapai! Anggaran disetujui dan siap diterbitkan Surat Penawaran Resmi.';
    } else if (val === 'batal') {
        infoText.textContent = 'Klien batal melanjutkan permohonan riset (diarsipkan rapi).';
    }
}
