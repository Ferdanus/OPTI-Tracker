                ...
                <form action="<?= ($BASE) ?>/order/simpan" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="nomor_order" class="form-label fw-semibold">Nomor Order</label>
                            <input type="text" class="form-control" id="nomor_order" name="nomor_order" placeholder="Kosongkan untuk auto-generate">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="jumlah_pekerjaan" class="form-label fw-semibold">Jumlah Pekerjaan / Alat <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="jumlah_pekerjaan" name="jumlah_pekerjaan" required placeholder="Contoh: 10 sampel pulp, 2 cerobong">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="estimasi_biaya" class="form-label fw-semibold">Estimasi Biaya (Rp)</label>
                        <input type="number" class="form-control" id="estimasi_biaya" name="estimasi_biaya" placeholder="Masukkan nilai rupiah, contoh: 15000000">
                    </div>
