    ...
    <div class="form-preview-grid">
        ...
        <div>
                ...
                <div class="form-card-body">
                    <div class="row g-2">
                        <div class="col-sm-6">
                            ...
                            <input type="text" id="inputNama" name="nama" class="form-control form-control-sm" placeholder="Nama lengkap" value="<?= (($order['pic'] && $order['pic'] != '-' && $order['pic'] != '—') ? $order['pic'] : (($sp['nama'] && $sp['nama'] != '-' && $sp['nama'] != '—') ? $sp['nama'] : '')) ?>" required>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <input type="text" id="inputPerusahaan" name="perusahaan" class="form-control form-control-sm" placeholder="Nama instansi / PT" value="<?= (($order['nama_perusahaan'] && $order['nama_perusahaan'] != '-' && $order['nama_perusahaan'] != '—') ? $order['nama_perusahaan'] : (($sp['perusahaan'] && $sp['perusahaan'] != '-' && $sp['perusahaan'] != '—') ? $sp['perusahaan'] : '')) ?>" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-semibold text-dark mb-1" for="inputAlamat">Alamat</label>
                            <input type="text" id="inputAlamat" name="alamat" class="form-control form-control-sm" placeholder="Alamat perusahaan / klien" value="<?= (($order['alamat'] && $order['alamat'] != '-' && $order['alamat'] != '—') ? $order['alamat'] : (($sp['alamat'] && $sp['alamat'] != '-' && $sp['alamat'] != '—') ? $sp['alamat'] : '')) ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-card-body">
                    ...
                    <div class="row g-1 mb-2">
                        <div class="col-4">
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmTelepon" value="telepon" <?= ($sp['permintaan_melalui'] == 'telepon' ? 'checked' : '') ?>>
                                <label class="form-check-label small" for="pmTelepon">Telepon</label>
                            </div>
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmFax" value="fax" <?= ($sp['permintaan_melalui'] == 'fax' ? 'checked' : '') ?>>
                                <label class="form-check-label small" for="pmFax">Fax</label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmSurat" value="surat" <?= (($sp['permintaan_melalui'] == 'surat' || (!$sp['permintaan_melalui'] && $order['id'])) ? 'checked' : '') ?>>
                                <label class="form-check-label small" for="pmSurat">Surat</label>
                            </div>
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmEmail" value="email" <?= (($sp['permintaan_melalui'] == 'email' || (!$sp['permintaan_melalui'] && !$order['id'])) ? 'checked' : '') ?>>
                                <label class="form-check-label small" for="pmEmail">E-mail</label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmDatang" value="datang_langsung" <?= ($sp['permintaan_melalui'] == 'datang_langsung' ? 'checked' : '') ?>>
                                <label class="form-check-label small" for="pmDatang">Datang Langsung</label>
                            </div>
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="permintaan_melalui" id="pmPegawai" value="pegawai_bbspjis" <?= ($sp['permintaan_melalui'] == 'pegawai_bbspjis' ? 'checked' : '') ?>>
                    ...
                    <div class="d-flex gap-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_layanan" id="jlSelulosa" value="selulosa" <?= ($order['jenis_layanan_opti'] == 'lingkungan' ? '' : 'checked') ?>>
                            <label class="form-check-label small fw-semibold text-dark" for="jlSelulosa">OPTI Selulosa</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_layanan" id="jlLingkungan" value="lingkungan" <?= ($order['jenis_layanan_opti'] == 'lingkungan' ? 'checked' : '') ?>>
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    <textarea id="inputPenjelasan" name="penjelasan" class="form-control form-control-sm" rows="3" placeholder=""><?= (($order['deskripsi'] && $order['deskripsi'] != '-' && $order['deskripsi'] != 'Dengan penjelasan sebagai berikut...') ? $order['deskripsi'] : (($sp['penjelasan'] && $sp['penjelasan'] != '-' && $sp['penjelasan'] != 'Dengan penjelasan sebagai berikut...') ? $sp['penjelasan'] : '')) ?></textarea>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePreview() {
        ...
        var valPenjelasan = (elPenjelasan && elPenjelasan.value.trim() && elPenjelasan.value.trim() !== '-' && elPenjelasan.value.trim() !== 'Dengan penjelasan sebagai berikut...') ? elPenjelasan.value.trim() : '';
