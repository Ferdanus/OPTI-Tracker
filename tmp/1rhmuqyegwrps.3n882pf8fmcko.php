...
<div class="row g-3 mb-4" data-aos="fade-up">
    <div class="col-md-3 col-sm-6">
        <div class="card shadow-sm border-0 bg-white">
            <div class="card-body py-3 d-flex align-items-center gap-3">
                <div class="bg-danger bg-opacity-10 text-danger rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 48px; height: 48px;"><i class="bi bi-tag-fill fs-4"></i></div>
                <div>
                    <div class="text-muted small">OPTI Selulosa dan Derivat</div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card shadow-sm border-0 bg-white">
            <div class="card-body py-3 d-flex align-items-center gap-3">
                <div class="bg-success bg-opacity-10 text-success rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 48px; height: 48px;"><i class="bi bi-tag-fill fs-4"></i></div>
                <div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card shadow-sm border-0 bg-white">
            <div class="card-body py-3 d-flex align-items-center gap-3">
                <div class="bg-warning bg-opacity-10 text-warning rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 48px; height: 48px;"><i class="bi bi-clock-history fs-4"></i></div>
                <div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card shadow-sm border-0 bg-white">
            <div class="card-body py-3 d-flex align-items-center gap-3">
                <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 48px; height: 48px;"><i class="bi bi-arrow-repeat fs-4"></i></div>
                <div>
        ...
        <form method="GET" action="<?= ($BASE) ?>/po" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 col-sm-6">
                ...
                <select name="jenis_layanan" id="jenis_layanan" class="form-select form-select-sm">
                    ...
                    <option value="selulosa" <?= ($filter_jenis_layanan == 'selulosa' ? 'selected' : '') ?>>OPTI Selulosa dan Derivat</option>
                                    ...
                                    <td data-label="Klien & Layanan">
                                        ...
                                        <div class="mt-1">
                                            <?php if ($item['jenis_layanan'] == 'selulosa'): ?>
                                                <span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-20" style="font-size: 0.7rem;"><i class="bi bi-tag-fill me-1"></i>OPTI Selulosa dan Derivat</span>
                                            <?php endif; ?>
