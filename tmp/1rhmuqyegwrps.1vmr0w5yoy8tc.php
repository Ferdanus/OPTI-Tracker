...
" ?>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Otomatis kesaran sesuai order yang dipilih, tapi tetap bisa diganti manual.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tanggal Transaksi Bayar <span class="text-danger">*</span></label>
                            <input type="date" name="tanggal_bayar" class="form-control" value="<?= (date('Y-m-d')) ?>" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var inputPoId = document.getElementById('inputPoId');
    ...
    function syncDariOrderTerpilih() {
        ...
        inputPoId.value = opt.dataset.poId || '';
