<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Legalitas kontrak payung dan perjanjian teknis kemitraan jasa industri BBSPJIS.</p>
    </div>
...
" ?>
                                    ...
                                    <td>
                                        <div class="small text-dark fw-bold mb-1">
                                            <?= ($k['nama_penandatangan_bbspjis'] ?: 'Kepala BBSPJIS')."
" ?>
                                            <div class="text-muted fw-normal" style="font-size: 0.72rem;"><?= ($k['jabatan_penandatangan_bbspjis'] ?: 'BBSPJIS') ?></div>
                                        </div>
