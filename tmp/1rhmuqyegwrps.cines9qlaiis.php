                    ...
                    <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Pimpinan / Kepala Balai</td>
                                <td>
                                    <?php if ($po['app_proposal']): ?>
                                        
                                            <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-20"><i class="bi bi-check-circle-fill me-1"></i>Disetujui (<?= (date('d/m/Y H:i', strtotime($po['app_proposal_date']))) ?>)</span>
                            ...
                            <tr>
                                ...
                                <td><strong>2. Kontrak</strong></td>
                                <td>Pimpinan / PPK BLU</td>
                                <td>
                                    <?php if ($po['app_kontrak']): ?>
                                        
                                            <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-20"><i class="bi bi-check-circle-fill me-1"></i>Disetujui (<?= (date('d/m/Y H:i', strtotime($po['app_kontrak_date']))) ?>)</span>
