<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
            ...
            <p class="text-muted small m-0 mt-1">Evaluasi kesiapan teknis laboratorium sebelum permohonan diproses menjadi proposal / penawaran resmi.</p>
        </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="card border-primary-subtle bg-primary-subtle p-3 mb-4">
                            ...
                            <div id="boxAlasanPenolakan" class="mt-3" style="display: <?= ($tinjauan && $tinjauan['keputusan'] == 'tidak_dapat_dilaksanakan' ? 'block' : 'none') ?>;">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary d-flex align-items-center gap-2">
                                <i class="bi bi-save"></i> Simpan Evaluasi Kelayakan
                            </button>
                        </div>
                    </div>
                </div>
...
function toggleAlasanPenolakan() {
    ...
    var box = document.getElementById('boxAlasanPenolakan');
    if (radioTidak && box) {
        box.style.display = radioTidak.checked ? 'block' : 'none';
    }
}
</script>