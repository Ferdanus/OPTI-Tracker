<!-- Custom Style khusus untuk Responsivitas Tabel Order Layanan di Mobile -->
<style>
    @media (max-width: 767.98px) {
        ...
        /* Penyelarasan Tombol Aksi di bagian bawah Kartu */
        td[data-label="Aksi"] {
        ...
        td[data-label="Aksi"] div,
        td[data-label="Aksi"] button,
        td[data-label="Aksi"] a,
        td[data-label="Aksi"] span {
            width: 100% !important;
            display: block !important;
        }
        td[data-label="Aksi"] .d-flex {
                        ...
                        <tbody>
                            <?php $ctr=0; foreach (($daftar_order?:[]) as $order): $ctr++; ?>
                                <tr>
                                    ...
                                    <td class="small text-secondary" data-label="Tanggal">
...
" ?>
                                    ...
                                    <td data-label="Judul Kegiatan">
                                        ...
                                        <?php if ($order['deskripsi']): ?>
                                            <div class="small text-secondary text-truncate" style="max-width: 300px;" title="<?= ($order['deskripsi']) ?>"><?= ($order['deskripsi']) ?></div>
                                        <?php endif; ?>
                                    </td>
